...
let ReferralsController = class ReferralsController {
    ...
    async getIncomingReferrals(req) {
        const { role, facilityId } = req.user;
        if (role === 'ADMINISTRATOR')
            return this.referralsService.getAllReferrals();
        if (!facilityId)
...
__decorate([
    (0, common_1.Get)('my'),
    (0, roles_decorator_1.Roles)(client_1.Role.NURSE, client_1.Role.ADMINISTRATOR),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ReferralsController.prototype, "getIncomingReferrals", null);
__decorate([
